...
import numpy as np
import cv2
from augmentation import ImageDataAugmentation, save_image
...
if __name__ == "__main__":
    ...
    save_dataset = get_dataset_from_video('test_video.mp4')

    augmentor = ImageDataAugmentation(save_dataset)
